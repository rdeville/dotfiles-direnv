...
### 🩹 Patch
  ...
  * ⚡️(lib): Remove make_scripts_executables since devbox scripts might be command (!21) by Romain Deville ([`a863951`](https://framagit.org/rdeville-public/dotfiles/direnv/-/commit/a86395148ab8f606473515cc326f5c99cd9db6b5))
  * ⚡️(lib): Remove make_scripts_executables since devbox scripts might be command by Romain Deville ([`1d1b48d`](https://framagit.org/rdeville-public/dotfiles/direnv/-/commit/1d1b48d83ca54cafa19860ae6065f29bb2a2d0d3)) 🔏
  * ➖ Update flake.nix by Romain Deville ([`b720b0b`](https://framagit.org/rdeville-public/dotfiles/direnv/-/commit/b720b0b5fd894b574ac2c0fa1841b2da64b1cbdd)) 🔏
  * ⬆️ Update templated files from dotgit-sync (!20) by Romain Deville ([`1a0b7ae`](https://framagit.org/rdeville-public/dotfiles/direnv/-/commit/1a0b7aea5edd7841ebed35ea75d034322f413501))
  * ⬆️ Upgrade flake.lock by Romain Deville ([`69a38b4`](https://framagit.org/rdeville-public/dotfiles/direnv/-/commit/69a38b41241b2c48aae75c4508308f025e8c1e56)) 🔏
  * ⬆️ Update templated files from dotgit-sync by Dotgit Sync [bot] ([`33f42e7`](https://framagit.org/rdeville-public/dotfiles/direnv/-/commit/33f42e7bc5fbc90a5098298a99c4912553398393)) 🔏
  * 🐛 Make direnv now source my bash logger first (!22) by Romain Deville ([`368e48a`](https://framagit.org/rdeville-public/dotfiles/direnv/-/commit/368e48a2e2e257765d1907ae644746fe8c347322))
  * 🐛 Make direnv source logger at first by Romain Deville ([`af7431f`](https://framagit.org/rdeville-public/dotfiles/direnv/-/commit/af7431fb1723ee2f816169ed48fc9a840bd07c0a)) 🔏
  * 📦️ Add AUTHORS to nixpkgs by Romain Deville ([`ea03a9d`](https://framagit.org/rdeville-public/dotfiles/direnv/-/commit/ea03a9d85393958800c70d75497b464557f50ca7)) 🔏
